...
//Affichage
  ...
  echo "<H2 align=\"center\"><span id=titrepage>Recherche d'un cocktail</span></H2>\n";  //METTRE LE BON TITRE
...
// Affichage des action possibles
  if (!(isset($AlReady)))
  {
    ...
    echo "<p>Entrez le nom du cocktail recherché : <input type=\"text\" name=\"nomrec\">\n";
  ...
  else
  {
    ...
    $LaCle=$_POST["nomrec"];
    $AlReady="toto";
    $SQLS="SELECT Nom_Recette FROM t_recette WHERE Nom_Recette LIKE \"%$LaCle%\"";
    ...
    echo "<form name=\"autre\" Method=\"Post\" Action=\"rech_rec.php\">\n";
